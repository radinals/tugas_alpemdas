...
bool sqntial_search(int target, size_t& target_index, int array[],
                    size_t array_size);
...
void del_all(int target, int array[], size_t& array_size,
             bool (*search_algrthm)(int target, size_t& target_index,
...
// delete all instance of an item, this function takes a search algorithm for
// the searching
void
del_all(int target, int array[], size_t& array_size,
        bool (*search_algrthm)(int target, size_t& target_index, int array[],
                               size_t array_size))
{
	size_t target_index;
